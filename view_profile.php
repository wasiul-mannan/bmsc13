...
<body>
    ...
    <?php
    $sql = "SELECT * FROM bmsc13_members WHERE id='$m_id' ORDER BY id ASC";
                    ...
                    <div class="content-container col-12">
                        <div class="content-wrapper">
                            <div class="card-container">
                                ...
                                <a target="_blank" href="<?php echo $row['fb_id']; ?>" class="form-control"><?php echo $row['fb_id']; ?></a>

                                <h5 class="mbr-section-subtitle align-left mbr-fonts-style mb-0 display-7">INSTAGRAM ID : </h5>
                                <a target="_blank" href="<?php echo $row['insta_id']; ?>" class="form-control"><?php echo $row['insta_id']; ?></a>

                                <h5 class="mbr-section-subtitle align-left mbr-fonts-style mb-0 display-7">TWITTER ID : </h5>
                                <a target="_blank" href="<?php echo $row['twitter_id']; ?>" class="form-control"><?php echo $row['twitter_id']; ?></a>

                                <h5 class="mbr-section-subtitle align-left mbr-fonts-style mb-0 display-7">LINKEDIN ID : </h5>
                                <a target="_blank" href="<?php echo $row['linkedin_id']; ?>" class="form-control"><?php echo $row['linkedin_id']; ?></a>

                                <h5 class="mbr-section-subtitle align-left mbr-fonts-style mb-0 display-7">YOUTUBE CHANNEL : </h5>
                                <a target="_blank" href="<?php echo $row['youtube_channel']; ?>" class="form-control"><?php echo $row['youtube_channel']; ?></a>
