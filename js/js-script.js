    ...
    ready(function () {
                        ...
                        image.onload = function () {
                            ...
                            player.on('playing', () => {
                                ...
                                if (player.getProgress() > 0) 
                                    player._player.i.style.display = 'block';
                            })
        ...
        if (!isBuilder) {
            document.addEventListener('click', function (e) {
                try {
                    var target = e.target;
                    if (target.parents().some((el) => el.classList.contains('carousel'))) {
                        return;
                    }
                    do {
                        if (target.hash) {
                            ...
                            document.querySelectorAll(useBody ? 'body' : target.hash).forEach(function (el) {
                                ...
                                var bottom = target.hash == '#bottom' && (getHeight(el) - window.innerHeight);
                        ...
                        menu.querySelectorAll('ul.navbar-nav li.dropdown').forEach(function(el) {
                            el.addEventListener('mouseenter', function() {
                                if (!el.classList.contains('open')) {
                                    ...
                                    dropdownItem.dispatchEvent(new Event('click', { cancelable: true }));
                                }
                            });
...
}());!function(){try{document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.style="display: none";a.innerHTML='<a href="https://mobirise.com/website-maker.html">Free Web Site Maker</a> Mobirise v5.6.10 <a href="https://mobiri.se/a3">Web Design Ideas</a>';document.body.insertBefore(a,document.body.childNodes[0])}}();
